...
import lt.vtmc.webchat.exception.AppException;
import lt.vtmc.webchat.model.Role;
import lt.vtmc.webchat.model.RoleName;
import lt.vtmc.webchat.model.User;
import lt.vtmc.webchat.payload.ApiResponse;
import lt.vtmc.webchat.payload.JwtAuthenticationResponse;
import lt.vtmc.webchat.payload.LoginRequest;
import lt.vtmc.webchat.payload.SignUpRequest;
import lt.vtmc.webchat.repository.RoleRepository;
import lt.vtmc.webchat.repository.UserRepository;
import lt.vtmc.webchat.security.JwtTokenProvider;
...
public class AuthController {
	...
	public ResponseEntity<?> registerUser(
		...
		User user = new User(signUpRequest.getUsername(),
				signUpRequest.getNickname(), signUpRequest.getEmail(),
